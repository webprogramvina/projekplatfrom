...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_POST['data_terpilih'])) {
        ...
        $query = "UPDATE pembelian SET Status = 'Selesai' WHERE Status = 'Proses' AND ID_Nota_Beli IN ('$ids')";
...
$query = "SELECT * FROM pembelian WHERE Status = 'Proses'";
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td><input type='checkbox' name='data_terpilih[]' value='" . $row['ID_Nota_Beli'] . "'></td>";
                    echo "<td>" . $row['ID_Nota_Beli'] . "</td>";
                    echo "<td>" . $row['ID_Jeruk'] . "</td>";
                    echo "<td>" . $row['Quantity'] . "</td>";
                    echo "<td>" . $row['Nama_Supplier'] . "</td>";
                    echo "<td>" . $row['Tanggal_Pesan'] . "</td>";
                    echo "<td>" . $row['Tanggal_Diantar'] . "</td>";
